-- ============================================================
-- NEXUS - RESET COMPLETO - rode isso primeiro!
-- ============================================================
...
drop policy if exists "users_own_savings_tx" on savings_transactions;
drop policy if exists "users_own_goals" on goals;
drop policy if exists "users_own_goal_tx" on goal_transactions;
drop policy if exists "users_own_debts" on debts;
drop policy if exists "users_own_debt_payments" on debt_payments;
drop policy if exists "users_own_calendar" on calendar_bills;
